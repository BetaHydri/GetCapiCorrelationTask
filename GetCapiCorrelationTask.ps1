    ...
    <#
      ...
      .OUTPUTS
          ...
          DetailedMessage : <CertVerifyRevocation xmlns="http://schemas.microsoft.com/win/2004/08/events/event"><Certificate
                            ...
                            Sperrung nicht Ã¼berprÃ¼fen, da der Sperrserver offline war.</Result></CertVerifyRevocation>
          ...
          DetailedMessage : <CertGetCertificateChain xmlns="http://schemas.microsoft.com/win/2004/08/events/event"><Certificate
                            ...
                            konnte die Sperrung nicht Ã¼berprÃ¼fen, da der Sperrserver offline war.</RevocationResult><StrongSignProperties
                            ...
                            /><Result value="80092013">Die Sperrfunktion konnte die Sperrung nicht Ã¼berprÃ¼fen, da der Sperrserver offline
...
#Get-CapiTaskIDEvents -TaskID "18A01B70-ABB4-4276-9FAA-189BD8BFDB8C" | Format-List
